...
export function ProfileHeaderFull() {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden relative">
      {/* Cover Image */}
      <div className="relative h-48 md:h-60 bg-[#dbeafe]">
        <img
        ...
        />
        {/* Avatar - Overlapping */}
        <div className="absolute left-6 -bottom-16 md:left-8">
      ...
      <div className="pt-16 md:pt-20 px-6 md:px-8 pb-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-1 text-gray-500 text-sm mt-2 items-center">
          ...
          <div className="flex gap-2 mt-4 md:mt-0">
            <Button className="bg-[#0A66C2] hover:bg-[#004182] text-white rounded-full px-6 font-semibold h-10">Message</Button>
            <Button variant="outline" className="rounded-full border-gray-300 px-6 font-semibold h-10">More</Button>
          </div>
        </div>
      </div>
    </div>
